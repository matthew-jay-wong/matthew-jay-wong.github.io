...
export default function About() {
  return (
    ...
    >
      <h2>About Me</h2>
      <p>
        Like I said before, My name is Matt and I work in tech as a full-stack developer.
        ...
        to quickly familiarizing myself with large code bases in order to bring value to the project as soon as possible. While red tape exists to slow down development, I've always tried my best to never let this be the reason I cannot progress with development by opening a dialog with them.
      </p>
      <p>
